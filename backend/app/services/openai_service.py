...
class OpenAIService:
    ...
    async def _generate_chapter_content(self, chapter: dict, parent_chapters: list = None, sibling_chapters: list = None, project_overview: str = "", prompt: str = None) -> AsyncGenerator[str, None]:
        """
        为单个章节流式生成内容
